...
devel/lib/libmove_base.so: /usr/local/lib/libboost_system.so
devel/lib/libmove_base.so: /usr/local/lib/libboost_thread.so
devel/lib/libmove_base.so: /usr/local/lib/libboost_chrono.so
devel/lib/libmove_base.so: /usr/local/lib/libboost_date_time.so
devel/lib/libmove_base.so: /usr/local/lib/libboost_atomic.so
...
devel/lib/libmove_base.so: navigation/move_base/CMakeFiles/move_base.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/cx/brainnavi/ai_robot_ranger/src/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX shared library ../../devel/lib/libmove_base.so"
