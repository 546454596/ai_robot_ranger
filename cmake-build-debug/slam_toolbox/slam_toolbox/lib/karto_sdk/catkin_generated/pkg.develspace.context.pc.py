...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/home/cx/brainnavi/ai_robot_ranger/src/slam_toolbox/slam_toolbox/lib/karto_sdk/include;/usr/include;/usr/local/include".split(';') if "/home/cx/brainnavi/ai_robot_ranger/src/slam_toolbox/slam_toolbox/lib/karto_sdk/include;/usr/include;/usr/local/include" != "" else []
