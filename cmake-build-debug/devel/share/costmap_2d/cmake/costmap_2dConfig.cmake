...
if("TRUE" STREQUAL "TRUE")
  set(costmap_2d_SOURCE_PREFIX /home/cx/brainnavi/ai_robot_ranger/src/navigation/costmap_2d)
  set(costmap_2d_DEVEL_PREFIX /home/cx/brainnavi/ai_robot_ranger/src/cmake-build-debug/devel)
...
if(NOT "/home/cx/brainnavi/ai_robot_ranger/src/cmake-build-debug/devel/include;/home/cx/brainnavi/ai_robot_ranger/src/navigation/costmap_2d/include;/usr/local/include/eigen3;/usr/local/include " STREQUAL " ")
  set(costmap_2d_INCLUDE_DIRS "")
  set(_include_dirs "/home/cx/brainnavi/ai_robot_ranger/src/cmake-build-debug/devel/include;/home/cx/brainnavi/ai_robot_ranger/src/navigation/costmap_2d/include;/usr/local/include/eigen3;/usr/local/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'costmap_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cx/brainnavi/ai_robot_ranger/src/navigation/costmap_2d/${idir}'.  ${_report}")
    endif()
    _list_append_unique(costmap_2d_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "costmap_2d;layers;/usr/local/lib/libboost_system.so;/usr/local/lib/libboost_thread.so;-lpthread;/usr/local/lib/libboost_chrono.so;/usr/local/lib/libboost_date_time.so;/usr/local/lib/libboost_atomic.so")
