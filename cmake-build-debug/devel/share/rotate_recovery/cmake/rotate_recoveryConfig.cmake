...
if(NOT "/home/cx/brainnavi/ai_robot_ranger/src/navigation/rotate_recovery/include " STREQUAL " ")
  set(rotate_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/cx/brainnavi/ai_robot_ranger/src/navigation/rotate_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cx/brainnavi/ai_robot_ranger/src/navigation/rotate_recovery/${idir}'.  ${_report}")
    endif()
