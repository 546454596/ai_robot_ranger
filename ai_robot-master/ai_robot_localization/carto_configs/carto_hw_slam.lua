...
POSE_GRAPH.optimization_problem.rotation_weight = 0.5
...
--POSE_GRAPH.constraint_builder.loop_closure_translation_weight = 5.5e3
--POSE_GRAPH.constraint_builder.loop_closure_rotation_weight = 5e4
