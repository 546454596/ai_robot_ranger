...
private:
    ros::NodeHandle nh;
    ros::Subscriber semap_sub, elemap_sub, order_sub, joy_sub, target_sub, targetodom_sub, odom_sub;
    ...
    double y, deltx, delty, last_x, last_y;
    pair<double, double> x;
    pair<double, double> pose_pair;
    deque<pair<double, double>> deque_pose;
    boost::chrono::system_clock::time_point t1, t2, success_t, last_success_t;
    boost::chrono::duration<double> time_used, success_time_used;
    bool moving_flag, test_flag, backward_flag;
    int turnback_cnt = 0;
